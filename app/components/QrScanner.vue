...
async function initializeCamera() {
  try {
    // Video element should already be in the DOM since it's always rendered
    await nextTick();
    ...
    console.log('Video element found:', videoElement.value);
    ...
    console.log('Camera available, getting camera list...');
