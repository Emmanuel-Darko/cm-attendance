  ...
  <BaseModal @close="hideModal">
    <template #header>
      <div class="flex flex-col items-center text-center">
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-1">Confirm Action</h2>
    ...
    <template #footer>
      <div class="flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
        ...
        >
          <svg v-if="processing" class="w-4 h-4 animate-spin mx-auto" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
