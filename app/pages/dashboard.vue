  ...
  <div class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
    <div class="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6">
      ...
      <div class="pt-2 sm:pt-4 pb-2">
        <NuxtLink
          to="/"
          class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-white/80 hover:bg-white text-gray-600 hover:text-indigo-600 text-xs sm:text-sm font-medium border border-gray-200 shadow-sm transition-all"
        >
      ...
      <!-- Compact Hero Banner -->
      <HeroBanner @cta="goCheckin" class="mt-2 sm:mt-4" />
      ...
      <div class="flex flex-col items-center my-16 sm:my-20 gap-4">
        <!-- Android PWA install -->
        <button
          v-if="isInstallable"
          @click="install"
