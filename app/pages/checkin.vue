  ...
  <div v-else class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
    <div class="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
      ...
      <div class="mb-4 sm:mb-6 md:mb-8">
        <NuxtLink to="/dashboard" class="group inline-flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 bg-white rounded-lg sm:rounded-xl shadow-sm hover:shadow-md transition-all duration-300 text-gray-700 hover:text-indigo-600 border border-gray-100">
      ...
      <div>
        ...
        <div v-else>
          ...
          <!-- Tab Navigation: Manual default and first, QR as second -->
          ...
          <div v-if="selectedSessionId" class="bg-white rounded-xl sm:rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <!-- Manual Table View (default tab is manual, so show first if manual is chosen) -->
            <transition name="fade" mode="out-in">
              <div v-if="checkinView === 'manual'" key="manual" class="p-4 sm:p-5 md:p-6">
              ...
              <!-- QR Scanner View (second tab) -->
              <div v-else-if="checkinView === 'scanner'" key="scanner" class="p-6 sm:p-8 md:p-12">
...
const checkinView = ref<'scanner'|'manual'>('manual')
